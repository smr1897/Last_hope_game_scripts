...
{
    public float scrollDirection; //For weapon swapping
    ...
    {
        actions.rHandAim.weight = Mathf.Lerp(actions.rHandAim.weight, 1, 10 * Time.deltaTime);//Increasing reload animation speed. weight is increasing linearly.
